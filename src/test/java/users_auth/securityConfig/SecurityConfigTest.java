...
class SecurityConfigTest {
  ...
  void jwtDecoder_setsValidator() {
    org.springframework.security.oauth2.jwt.NimbusJwtDecoder decoder =
        org.mockito.Mockito.mock(org.springframework.security.oauth2.jwt.NimbusJwtDecoder.class);
    try (org.mockito.MockedStatic<org.springframework.security.oauth2.jwt.JwtDecoders> m =
        org.mockito.Mockito.mockStatic(org.springframework.security.oauth2.jwt.JwtDecoders.class)) {
      m.when(
              () ->
                  org.springframework.security.oauth2.jwt.JwtDecoders.fromIssuerLocation(
